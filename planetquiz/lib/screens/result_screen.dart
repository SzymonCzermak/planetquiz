        ...
        body: Container(
          ...
          child: Stack(
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                            color: orange, width: 2), // Kolor ramki i jej grubość
              ...
              // Pokaż kod zniżkowy przy >=8 punktach
              if (widget.score >= 8)
                Positioned(
                  bottom: 250,
                  top: 800,
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(40), // Konsystentne zaokrąglenie
                        boxShadow: [
                          BoxShadow(
                            color: Color.fromRGBO(187, 0, 187, 0.404), // Adjusted purple shadow
                            spreadRadius: 15,
                            blurRadius: 60,
                            offset: Offset(0, 8),
                          ),
              ...
              // Przycisk "Spróbuj Ponownie", wyświetlany zawsze
              Positioned(
                bottom: 100,
                top: 900,
                left: 150,
